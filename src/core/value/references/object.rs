...
use std::fmt;
use std::rc::Rc;
use crate::core::err::{assignment_error, reference_error, ReferenceType};
use crate::core::value::{display_indent, Addr, ComplexStructure, GetAddr};
    ...
    pub fn new(params: ListStorage<Value>, prototype: Option<Prototype>) -> Self {
        match prototype {
            ...
            None => {
                ...
                Self::BuildIn(BuildInObject { storage })
            }
        }
    }
