...
use crate::core::value::{into_rc_refcell, ComplexStructure, GetAddr};
use crate::core::value::number::Number;
use crate::core::value::references::array::{ArrayLiteral, RawArray};
use crate::core::value::references::class::Class;
use crate::core::value::references::function::{BuildInFunction, Function, UserDefinedFunction};
use crate::core::value::references::map::RawMap;
use crate::core::value::references::object;
use crate::core::value::references::unique::Unique;
use crate::core::value::value::Value::Object;
...
impl ValueType {
    pub fn is_valid_type(id: &str) -> Option<ValueType> {
        unsafe {
...
impl fmt::Display for Value {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Object(obj) => object::Object::display(f, obj, 1),
...
impl GetAddr for Value {
    fn get_addr(&self) -> super::Addr {
        match self {
            ...
            Object(obj) => obj.borrow().get_addr(),
            _ => unreachable!(),
        }
    }
}
...
impl PartialEq for Value {
    fn eq(&self, other: &Self) -> bool {
        ...
        match (self, other) {
            ...
            | (Object(_), Object(_)) => self.get_addr() == other.get_addr(),
            _ => unreachable!(),
        }
    }
